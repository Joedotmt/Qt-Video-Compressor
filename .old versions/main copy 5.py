...
class VideoCompressor(QWidget):
    ...
    def __init__(self):
        ...
        self.vid_bit_input.setPlaceholderText("Estimated Bitrate (kbps)")
    ...
    def start_compression(self): 
        ...
        try:
            ...
            audio_bitrate = int(self.audio_bitrate_input.text()) * 1000 if not self.mute_audio.isChecked() else 0
        except:
